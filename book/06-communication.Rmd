...
```{r ch06-shiny-greeting-figure, echo=FALSE, fig.cap="教材图 6.34：简单姓名交互应用。", out.width="76%"}
...
```{r ch06-shiny-clt-figure, echo=FALSE, fig.cap="教材图 6.36：中心极限定理 Shiny 应用。", out.width="88%"}
...
```{r ch06-shiny-dashboard-figures, echo=FALSE, fig.cap="教材图 6.37—6.38：数据展板的图形页与数据表页。", out.width="96%"}
knitr::include_graphics(c(
